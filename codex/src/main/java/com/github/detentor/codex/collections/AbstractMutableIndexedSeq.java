 ...
 * <br/>
 * 
 * {@link Iterable#iterator() iterator()} , {@link SharpCollection#size() size()} , {@link #subsequence(int, int)} ,
 * {@link #apply(Integer)} , {@link SharpCollection#add(T) add()} , {@link SharpCollection#removeIndex(T) remove()} ,
 * {@link SharpCollection#clear() clear()} , {@link SharpCollection#builder() builder()} <br/>
 * <br/>
 * 
 * Não esquecer de sobrescrever o equals e o hashcode também. <br/>
 * <br/>
 * 
 * Para coleções imutáveis, veja {@link AbstractIndexedSeq}. <br/>
 * <br/>
 * 
 ...
 * 
 */
public abstract class AbstractMutableIndexedSeq<T, U extends IndexedSeq<T>> extends AbstractIndexedSeq<T, U> implements IndexedSeq<T>,
