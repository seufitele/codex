 ...
 * Either representa uma alternativa a {@link Option}, onde a Option vazia seria representado por Left.
 * Ao contrário de Option, entretanto, Left pode possuir um valor útil (por exemplo, uma mensagem de erro). <br/> <br/>
 * 
 * Convenção dita que Left é usado para os casos de falha (resultados não esperados), 
 * e Right para os de sucesso (resultados esperados). <br/> <br/>
 * 
 ...
 */
public abstract class Either<B, A>
{
	/**
