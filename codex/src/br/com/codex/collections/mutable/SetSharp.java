...
import br.com.codex.collections.builders.HashSetBuilder;
...
public class SetSharp<T> extends AbstractMutableCollection<T, SetSharp<T>>
{
	...
	private SetSharp(final Set<T> backSet)
	{
	...
	/**
	 * Cria uma instância de SetSharp a partir dos elementos existentes
	...
	public boolean equals(final Object obj)
	{
		...
		if (backingSet == null)
		{
			...
			if (!backingSet.equals(other.backingSet))
			{
				return false;
			}
		return true;
