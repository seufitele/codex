...
public class Tuple2<A, B>
{
	...
	public Tuple2(final A valor1, final B valor2)
	{
		this.val1 = valor1;
		this.val2 = valor2;
	}
	...
	/**
	 * Retorna uma nova tupla, com as posições de cada elemento invertidas.
	 * @return Uma nova tupla, onde os elementos estão em posições trocadas.
	 */
	public Tuple2<B, A> swap()
	{
		return new Tuple2<B, A>(this.val2, this.val1);
	}
}
