...
public class SharpCollectionHOF
{
			...
			final Function1<? super T, ? extends Iterable<W>> fmapFunc, final T eleNotInCollection, final T... elems)
	{
		...
		final PartialFunction1<T, U> partFunc = createPartial(filterFunc, mapFunc);
...
//		}
	...
	private static <A, B> PartialFunction1<A, B> createPartial(final Function1<? super A, Boolean> pred,
			final Function1<? super A, B> transform)
	{
		return new PartialFunction1<A, B>()
		{
			@Override
