...
public class CatTest
{
			...
			final Function1<A, B> func1)
	{
		...
		Arrow2<A, Function1<A, B>, B> appFunc = new Arrow2<A, Function1<A,B>, B>()
		{
			@Override
			...
			final Function1<A, Monad<B>> bind1, final Function1<B, Monad<C>> bind2, final Function1<B, C> func1)
	{
		...
		Arrow2<Monad<A>, A, Monad<A>> pureF = new Arrow2<Monad<A>, A, Monad<A>>()
		{
			@Override
		...
		Arrow1<A, Monad<C>> comb = new Arrow1<A, Monad<C>>()
		{
			@Override
